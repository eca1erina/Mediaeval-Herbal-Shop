...
public class ImmortalityHerbs extends JsonManager implements Infusible, Comparable {
    ...
    public int infuseHerb(int indices[]) throws HerbNotFoundException, InsufficientQuantityException {
        ...
        System.out.println("O endless lyf, I thee implore,\n" + 
                        "By starres above and ocean’s shore.\n" + 
                        "Let flesh ne fade, nor spirit flee,\n" + 
                        "Granteth the boundlesse eternitee.\n");
    ...
    public void printHerbs() {
        System.out.println("\n No problem! Choose the herbs and your wish will come true: \n");
        for (int i=0; i<herbs.size(); i++) {
